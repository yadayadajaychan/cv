...
\begin{itemize}
	\item Assisted students with their training
	\begin{itemize}
		\item Lithography, Deposition, Etching, Metrology, Process Controls, and CAD
	\end{itemize}
	\item Connected topics learned in lecture with what students do in the lab
\end{itemize}
...
\begin{itemize}
	\item Learned about the semiconductor fabrication process
	\item Learned about device design
	\item Simulated fabrication with TCAD
	\item Fabricated MOSFETs in the lab starting from a blank wafer
\end{itemize}
...
\begin{itemize}
	\item Worked in a group of three to code the game ``2048'' in Verilog
	\item Learned about digital logic design
	\item Implemented the game graphics and VGA output
\end{itemize}
...
\begin{itemize}
	\item Made an X-Y recorder draw pictures
	\item Learned about how G-code works and implemented a subset of G-code instructions
	\item Used an Arduino to read G-code and convert it into voltages read by the X-Y recorder
\end{itemize}
...
\begin{itemize}
	\item Converted an electric typewriter into a teleprinter
	\item Soldered a microcontroller to the keyboard matrix to emulate keystrokes
	\item Learned about how keyboard scanning works
	\item Text sent over serial from a PC is converted into keystrokes and get printed
\end{itemize}
...
\begin{itemize}
	\item Created a webapp using PostgreSQL, Flask, and React.js
	\item Learned about web security and best practices (CORS, XSS, HttpOnly Cookies, cryptography)
	\item Designed and implemented backend API
	\item Managed backend infrastructure
\end{itemize}
...
\begin{itemize}
	...
	\item Designed custom CRC to protect data
	\begin{itemize}
